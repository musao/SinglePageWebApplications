...
spa.shell = (function () {
    ...
    // 目的：URIアンカー要素部分を変更する
    // 引数：
    //   * arg_map - 変更したいURIアンカー要素を表すマップ
    // 戻り値：boolean
    //   * true - URIアンカー要素が更新された
    //   * false - URIアンカー要素が更新できなかった
    // 動作：
